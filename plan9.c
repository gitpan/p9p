...
/* Stubs for <arpa/inet.h> replacement, "arpa.h" */
unsigned long inet_addr(const char *)
{
croak("Function \"inet_addr\" not implemented in this version of perl.");
}

char * inet_ntoa(struct in_addr)
{
croak("Function \"inet_ntoa\" not implemented in this version of perl.");
}
